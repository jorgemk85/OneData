...
namespace OneData.DAO.MySql
{
    internal class MySqlValidation : IValidatable
    {
        ...
        public bool IsNoLongerPrimaryKey(Dictionary<string, ConstraintDefinition> constraints, string uniqueConstraintName, OneProperty property)
        {
            return constraints.ContainsKey(uniqueConstraintName) && property.PrimaryKeyAttribute == null;
        }
